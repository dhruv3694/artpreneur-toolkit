    ...
    <Card className="p-6 shadow-card h-[600px] flex flex-col">
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-2xl font-bold">AI Creative Mentor</h2>
        </div>
        {messages.length > 0 && (
      ...
      <p className="text-sm text-muted-foreground mb-4">
        Get personalized guidance, overcome creative blocks, and grow your art practice
      </p>
        ...
        <div className="space-y-4">
          {messages.length === 0 ? (
            <div className="text-center text-muted-foreground py-8">
              ...
              <p className="text-xs mt-2">Ask about pricing, creative blocks, marketing, or anything!</p>
            </div>
          ) : (
